...
## Modelling interdependence or constraints

Although this was not the primary focus in designing the framework, it is possible to model interdependence between patients. This could be useful for modelling constraints, or for modelling transmission processes. An example implementing a simple SIR (Susceptible-Infectious-Recovered) infection transmission model is provided near the of the vignette [here](vignettes/getting-started.Rmd).